  ...
  return (
    <>
      <div>
        ...
        <div className="bg-[#fff] min-h-[150px] mt-4 rounded-xl p-4">
          <div className="flex justify-between ">
            <span className="font-[500]">Urban Heights Estate</span>
            <span
              onClick={handleOpen}
              className="text-[#ff2121] cursor-pointer"
            >
              Deactivate Estate
            </span>
          </div>
          <div className="flex gap-5 mt-6 text-[#646464] text-[14px]">
            ...
            <div className=" min-w-[150px]">
              <div className=" flex flex-col gap-1  ">
                <span>221 - 231 Hahn Cape, Lekki Ajah, Nigeria</span>
                <span>yemi.fig@gmail.com</span>
                <span>+23456554453</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4  mt-4 justify-between">
          <Link to={`/communities/${id}/liscence_purchased`}
            style={{
          ...
          <Link to={`/communities/${id}/total_residents`}
            style={{
              boxShadow: "rgba(0, 0, 0, 0.04) 0px 3px 5px",
            }}
            className="bg-[#fff] p-3 flex-1  rounded-lg"
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[14px]">Residents/Units</span>
                <span className="text-[25px] font-semibold ">0</span>
              </div>
            </div>
          </Link>
          <Link to={`/communities/${id}/dues_created`}
            style={{
              boxShadow: "rgba(0, 0, 0, 0.04) 0px 3px 5px",
            }}
            className="bg-[#fff] p-3 flex-1  rounded-lg"
        ...
        <div className="min-h-[400px] mt-4 flex gap-4">
          ...
          >
            <div className="flex justify-between items-center">
              <span className="font-[500]">Residents</span>
              <button
                onClick={handleOpenOption}
                className="bg-[#E7F0FE] text-[#084191] py-[3px] rounded-xl px-2 "
              >
                + Add Resident
              </button>
            </div>
          ...
          >
            <div className=" p-3">Recent License Purchase</div>
            <div className="">
              <table className="min-w-full bg-white   ">
                <thead>
                  <tr className="bg-[#eef3ff] flex">
                    <th className="px-2 flex-1 flex justify-center  text-left font-[500] text-[#5E5E61] border-x text-[14px] py-2">
                      Date
                    </th>
                    <th className="px-2 flex-1 flex justify-center  text-left font-[500] text-[#5E5E61] border-x text-[14px] py-2">
                      Unit
                    ...
                    <th className="px-2 flex-1 flex justify-center  text-center font-[500] text-[#5E5E61] border-x text-[14px] py-2">
                      Amount (N)
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="bg-[#f5f5f5]">
                  {sideTableData.map((item, index) => (
                    <tr
                      key={index}
                      className={` flex cursor-pointer hover:bg-[#f5fcff] ${
                        index % 2 === 0 ? "bg-[#fff0]" : "bg-[#f9f9f900]"
                      }`}
                    >
                      <td className="px-2 flex-1 flex justify-center py-2  text-[#5E5E61] border-x text-[14px] font-[400]">
                        {item.date}
                      </td>
                      <td className="px-2 flex-1 flex justify-center py-2  text-[#5E5E61] border-x text-[14px] font-[400]">
                        {item.unit}
                      ...
                      <td className="px-2 flex-1 flex justify-center py-2  text-center  text-[#5E5E61] border-x text-[14px] font-[400]">
                        {item.amount}
                      </td>
                    </tr>
                  ))}
