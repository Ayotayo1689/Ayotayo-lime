        ...
        <div className="bg-white mt-4 p-4 rounded-2xl">
          <div className=" gap-4 p-4 bg-[#f2f2f2] rounded-lg  justify-between">
            <div className="flex justify-between items-center mb-3">
              <span className="font-[500]">Groups</span>
              <Button
                sx={{
                  textTransform: "none",
                  bgcolor: "#0D6CF2",
            ...
            <div className="flex gap-4">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col flex-1">
                    <span className="text-[14px]">Group Created</span>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col flex-1">
                    <span className="text-[14px]">Active Group</span>
                    <span className="text-[25px] font-semibold ">0</span>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2">
                  <img src={house} alt="" />
                  <div className="flex flex-col flex-1">
                    <span className="text-[14px]">Inactive Deus</span>
                    <span className="text-[25px] font-semibold ">0</span>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    {currentItems.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2  text-center  font-[400] text-[#C28103] text-[16px]">
                          Deactivate
                        </td>
                      </tr>
                    ))}
